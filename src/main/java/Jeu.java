...
public class Jeu extends JPanel implements KeyListener {
    ...
    public void keyPressed(KeyEvent e) {
        if (e.getKeyChar() == 'z' || e.getKeyCode() == KeyEvent.VK_UP) {
            ...
            e.getKeyChar() == 's' || e.getKeyCode() == KeyEvent.VK_DOWN
        ) {
            t1.descendre();
            t1.generation();
            tableauDeJeu = t1.toString();
            ...
            e.getKeyChar() == 'q' || e.getKeyCode() == KeyEvent.VK_LEFT
        ) {
            t1.gauche();
            t1.generation();
            tableauDeJeu = t1.toString();
            ...
            e.getKeyChar() == 'd' || e.getKeyCode() == KeyEvent.VK_RIGHT
        ) {
            t1.droite();
            t1.generation();
            tableauDeJeu = t1.toString();
    ...
    public void paint(Graphics g) {
        ...
        g2.drawString(
            "Highest Tile: " + t1.getLeCarreeLePlusGros(),
